              ...
              <div className="space-y-4">
                {day.events.map((event, eventIndex) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    aria-labelledby={`event-${eventIndex}`}
                  >
                    <span className="text-primary-500 min-w-[100px]">
                      {event.time}
                    </span>
                    <span id={`event-${eventIndex}`}>{event.title}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
